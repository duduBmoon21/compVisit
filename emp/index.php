...
if (isset($_POST['login'])) {
    ...
    if ($result) {
        ...
        if ($result->role_id == 1) {
            echo "<script type='text/javascript'> document.location = 'db-dashboard.php'; </script>";
        } else {
            echo "<script type='text/javascript'> document.location = 'employee_dashboard.php'; </script>";
        }
    } else {
