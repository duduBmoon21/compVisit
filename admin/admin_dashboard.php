                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="panel panel-default">
                                    ...
                                    <a href="userdetails.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="col-md-3">
                                <div class="panel panel-default">
                                    <div class="panel-body bk-success text-light">
                                        <div class="stat-panel text-center">
                                            <?php 
                                            $sql2 = "SELECT id FROM visitors";
                                            $query2 = $dbh->prepare($sql2);
                                            $query2->execute();
                                            $totalVisitors = $query2->rowCount();
                                            ?>
